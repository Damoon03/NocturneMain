...
class SettingsStore: ObservableObject {
    ...
    // MARK: - Lyrics font
    @Published var lyricsFont: LyricsFontOption {
        didSet { UserDefaults.standard.set(lyricsFont.rawValue, forKey: "nocturne_lyricsFont") }
    }
    ...
    init() {
        ...
        let storedFontRaw = UserDefaults.standard.string(forKey: "nocturne_lyricsFont")
        lyricsFont = storedFontRaw.flatMap(LyricsFontOption.init(rawValue:)) ?? .monospaced
